  ...
  return (
    <div className="flex flex-col">
      ...
      <button
        ...
        className={` fixed md:hidden bottom-6 left-4 ${openExtras ? "bg-gray-300/80" : ""} bg-gray-200 rounded-4xl p-2 text-3xl shadow-gray-300 shadow-sm focus:opacity-100 hover:shadow-md cursor-pointer hover:opacity-75 transition-all duration-200`}
      >
      ...
      <div className={`${openExtras ? "flex" : "hidden"} z-1000`}>
        <button
          ...
          className={`fixed ${openAccess ? "border-black bg-gray-200" : "bg-gray-400"} md:hidden bottom-6 left-18 rounded-4xl p-2 text-3xl shadow-gray-300 shadow-sm focus:opacity-100 hover:shadow-md cursor-pointer ring-1 ring-gray-800/85 transition-all hover:opacity-75 duration-300`}
        >
          <BsFillShieldLockFill />
        </button>
        <button
          onClick={() => setOpenCreate(!openCreate)}
          className={`fixed ${openCreate ? "border-black bg-gray-200" : "bg-gray-400"} md:hidden bottom-6 left-32 rounded-4xl p-2 text-3xl shadow-gray-300 shadow-sm focus:opacity-100 hover:shadow-md cursor-pointer ring-1 ring-gray-800/85 transition-all hover:opacity-75 duration-300`}
        >
          <IoMdAddCircle />
        </button>
        <button
          onClick={() => setOpenStats(!openStats)}
          className={`fixed ${openStats ? "border-black bg-gray-200" : "bg-gray-400"} md:hidden bottom-6 left-46 rounded-4xl p-2 text-3xl shadow-gray-300 shadow-sm focus:opacity-100 hover:shadow-md cursor-pointer ring-1 ring-gray-800/85 transition-all hover:opacity-75 duration-300`}
        >
          <IoStatsChart />
        </button>
      </div>
