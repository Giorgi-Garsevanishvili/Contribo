  ...
  return (
    <div
      className={`fixed inset-0 flex justify-center items-start transition ${
        confirmState.isOpened ? "w-screen h-screen bg-gray-900/85" : "pointer-events-none opacity-0"
      }  z-50`}
    >
      <div className="flex bg-gray-300 p-15 mt-20 rounded-2xl shadow-2xl">
        <div className="flex flex-col">
          <div>
            <h4 className="font-bold p-1">{confirmState.title}</h4>
