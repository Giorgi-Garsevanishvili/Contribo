  ...
  return (
    <footer className="flex justify-center bg-transparent  overflow-hidden h-auto w-vw p-4 m-0">
      <div className="text-center m-0">
        <h1 className="orbitron p-2 px-5 rounded-lg bg-gray-100/85 md:px-0 md:rounded-none md:p-0 md:bg-transparent text-lg font-bold text-[#34495e] m-0 inline-block select-none relative">
