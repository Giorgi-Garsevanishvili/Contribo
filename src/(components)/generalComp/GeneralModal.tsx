...
function GeneralModal() {
  ...
  return (
    <div className="fixed inset-0  z-205 bg-[#00000040] flex items-center justify-center">
      <div
        className="bg-cyan-950 md:w-[60%] overflow-scroll h-[90%] shadow-md shadow-gray-400 border border-gray-700 w-[90%] gap-3 items-center justify-start flex flex-col text-white relative rounded-md p-2"
