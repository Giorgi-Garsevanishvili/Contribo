  ...
  return (
    <>
      <button
        ...
        } flex hover:shadow-lg backdrop-blur-xs hover:opacity-95 transition-all duration-300 btn flex-col select-none w-40 h-40 items-center justify-center mt-0 m-2 text-white pt-0 p-0.5 bg-[#434d5fa0] rounded-xl shadow-sm shadow-white `}
      >
        {!hover ? (
          <>
